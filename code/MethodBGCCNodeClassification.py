...
from code.MethodBGCC import MethodBGCC
...
class MethodBGCCNodeClassification(BertPreTrainedModel):
    ...
    def __init__(self, config, dropout_rate=0.1):
        super(MethodBGCCNodeClassification, self).__init__(config)
        self.config = config
        self.bert = MethodBGCC(config)
